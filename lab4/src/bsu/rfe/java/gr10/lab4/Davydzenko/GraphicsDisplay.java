...
// Шаг 5 - Чтобы изображение было неискажнным - масштаб должен быть одинаков
...
// Оси рисуются чрным цветом
        canvas.setColor(Color.BLACK);
// Стрелки заливаются чрным цветом
...
// Вычисляем смещение Y от точки верхней точки (maxY)
     ...
     * смещнный по отношению к исходному на deltaX, deltaY
